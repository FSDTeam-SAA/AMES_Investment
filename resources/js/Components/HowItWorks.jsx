  ...
  return (
    <section className="relative min-h-screen lg:h-[700px] w-full overflow-hidden  px-4 py-20">
      <div className="mx-auto max-w-6xl text-center ">
        <Badge  className="mb-6 border-[#44444A] text-white pr-[16px] py-1 pl-[8px]">
        ...
        <div className="grid gap-8 md:grid-cols-3 md:gap-12">
          <div className="group flex flex-col items-center">
            <div className="mb-6 flex h-16 w-16 items-center justify-center rounded-full border border-gray-800 bg-black/50 transition-all duration-200 group-hover:border-gray-700 sm:h-20 sm:w-20">
