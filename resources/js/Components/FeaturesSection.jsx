...
export default function FeaturesSection() {
    return (
        <div className=" lg:h-[700px] bg-[#111111] text-white">
            <div className="container mx-auto px-4 py-16 md:py-24">
                ...
                <div className="mb-16 max-w-6xl">
                    ...
                    <p className="text-lg text-gray-400 md:text-xl">
                        Discover the innovative features that set us apart in
                        the world of investing. Built to empower you with simple
                        smart tools making it possible for you to have the best
                        return.
                    </p>
                </div>
                ...
                <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div className="group relative overflow-hidden rounded-2xl bg-zinc-900/50 p-8 transition-all hover:bg-zinc-900/75">
                        ...
                        <p className="text-gray-400">
                            Advanced AI that analyzes market trends and executes
                            smart trades automatically.
                        </p>
                    </div>
                    ...
                    <div className="group relative overflow-hidden rounded-2xl bg-zinc-900/50 p-8 transition-all hover:bg-zinc-900/75">
                        ...
                        <p className="text-gray-400">
                            99% of our users report satisfaction with Ames
                            Investment Systems.
                        </p>
                    </div>
                    ...
                    <div className="group relative overflow-hidden rounded-2xl bg-zinc-900/50 p-8 transition-all hover:bg-zinc-900/75">
                        ...
                        <p className="text-gray-400">
                            The stability you need to stay ahead of market
